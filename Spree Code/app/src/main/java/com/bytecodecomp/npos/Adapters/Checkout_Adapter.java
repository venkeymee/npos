...
public class Checkout_Adapter extends BaseAdapter {
    ...
    public Checkout_Adapter(ArrayList<String> product_id, ArrayList<String> product_name, ArrayList<String> product_value, ArrayList<String> product_units, ArrayList<String> product_add_date, ArrayList<String> product_update_date, ArrayList<String> product_gtin, Dialog dialog, Activity activity,DatabaseReference  cartDatabaseReference, ArrayList<String> product_inventory){
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) view = inflater.inflate(R.layout.item_product_checkout, null);
        {


            Log.e("INV...", product_inventory.get(i));
            ...
            btn_add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    int inventory = Integer.parseInt(product_inventory.get(i)) + 0;
