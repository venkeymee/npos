...
public class Package_Model {
    ...
    public String package_name, package_exp, package_cost, package_period, package_id;
    ...
    public Package_Model(boolean store_inventory, int store_inventory_limit, boolean store_purchase, int store_purchase_daily_limit, boolean store_sales, int store_sales_daily_limit, boolean store_customer, int store_customer_limit, boolean store_supplier, int store_supplier_limit, boolean store_staff, int store_staff_limit, boolean store_assets, int store_assets_limit, boolean store_exp_type, int store_exp_type_limit, boolean store_exp, int store_exp_limit, String package_name, String package_exp, String package_cost, String package_period, String package_id) {
