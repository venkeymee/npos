...
public class Product_Inventory_Details {
    ...
    public Product_Inventory_Details() {
    }

    // constructor
    public Product_Inventory_Details(String product_id, String product_name, String product_value, String product_units, String product_add_date, String product_update_date, String product_gtin, String product_buying_price, String product_vat) {
    ...
    public String getProduct_buying_price() {return this.product_buying_price;}
    public void setProduct_buying_price(String product_buying_price) {this.product_buying_price = product_buying_price;}
