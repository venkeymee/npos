package com.bytecodecomp.npos.Plugins.notification;
...
import com.bytecodecomp.npos.Activities.User.LandingActivity;
    ...
    public void notificationOpened(OSNotificationOpenResult result) {
        ...
        if (data != null) {
            ...
            if (activityToBeOpened != null && activityToBeOpened.equals("AnotherActivity")) {
                ...
                Intent intent = new Intent(AppController.getContext(), LandingActivity.class);
