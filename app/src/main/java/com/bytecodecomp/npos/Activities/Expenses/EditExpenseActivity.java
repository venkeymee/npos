...
public class EditExpenseActivity extends AppCompatActivity {
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (et_expense_name.getText().toString().length() <= 0 && et_expense_value.getText().toString().length() <= 0 && et_expense_date.getText().toString().length() <= 0 ){
                    ...
                    do_update_expense(et_expense_name.getText().toString(), et_expense_value.getText().toString(), et_expense_date.getText().toString() );
    ...
    public void spinner_expense_for(){
        ...
        usersDatabaseReference.child(user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(EditExpenseActivity.this, android.R.layout.simple_spinner_item, nomeConsulta);
    ...
    //update an expense
    public void do_update_expense(String expense_name, String expense_value, String expense_date){


        Toasty.success(getApplicationContext(), "Expense Updated", Toast.LENGTH_SHORT, true).show();

        SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm");
        String customer_add_date = sdf.format(new Date());
        String customer_update_date = customer_add_date;

        Expense_Model expense_model = new Expense_Model(expense_id, expense_name, expense_value, expense_type, expense_date, expense_for, customer_update_date, customer_add_date);
        expenseDatabaseReference.child(user.getUid()).child(expense_id).setValue(expense_model);
