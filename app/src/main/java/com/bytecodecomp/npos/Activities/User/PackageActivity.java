...
import com.bytecodecomp.npos.Adapters.Package_Adapter;
        ...
        packageDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                while((iterator.hasNext())){
                    ...
                    ((Package_Adapter)(((GridView)findViewById(R.id.list_view)).getAdapter())).notifyDataSetChanged();
                }
            }
            @Override
