                ...
                auth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(SignUpActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                Toasty.success(getApplicationContext(), "Account Created Successful", Toast.LENGTH_SHORT, true).show();
                                ...
                                if (!task.isSuccessful()) {
                                    Toasty.error(getApplicationContext(), "Authentication failed."  + task.getException(), Toast.LENGTH_SHORT, true).show();
                                } else {
