...
public class Product_Edit_Adapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        ((TextView)view.findViewById(R.id.txt_Product_count)).setText(i + 1);
        ...
        ((TextView)view.findViewById(R.id.txt_Product_sku)).setText(String.valueOf(product_gtin.get(i)) + " Units");
